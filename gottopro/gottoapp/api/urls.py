...
urlpatterns = [
    ...
    path('category-job-list/', views.CategoryJobListAPIView.as_view()),
    path('company-job-list/', views.CompanyJobListAPIView.as_view()),
    ...
    path('job-retrieve/', views.JobRetrieveAPIView.as_view()),
